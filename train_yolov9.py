...
Trains a YOLOv9 model on your custom dataset
...
def train_yolov9(
    ...
    Args:
        model_size: Model variant (t/s/m/c/e)
            - t: tiny
            - s: small
            - m: medium
            - c: compact (recommended)
            - e: extended
...
names: ['class1', 'class2', 'class3']
    ...
    print("\n" + "="*50)
    print("YOLOv9 Training Configuration")
    print("="*50)
    ...
    print("\nYOLOv9 Features:")
    print("  ✓ Programmable Gradient Information (PGI)")
    print("  ✓ GELAN architecture")
...
if __name__ == "__main__":
    # Example usage
    print("YOLOv9 Training Script")
    print("=" * 50 + "\n")
    
    # Option 1: Train from scratch
    results, metrics = train_yolov9(
        model_size='c',  # Options: 'n', 's', 'm', 'l', 'x'
    ...
    # results = resume_training('yolov9_runs/train_exp1/weights/last.pt')
